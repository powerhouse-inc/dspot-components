...
const SimpleStatCardSkeleton: React.FC<SimpleStatCardSkeletonProps> = ({
  withEquals = false,
}) => {
...
const Card = styled.div<WithIsLight & { withEquals: boolean }>(
  ({ isLight, withEquals }) => ({
...
const CardTitle = styled(BaseSkeleton)<{ withEquals: boolean }>(
  ({ withEquals }) => ({
    maxWidth: 71,
    height: 9.625,
    marginBottom: 19.38,
