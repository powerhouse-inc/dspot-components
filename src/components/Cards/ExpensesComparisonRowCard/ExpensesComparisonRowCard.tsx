...
import { GenericCell, RowProps } from "../../common/AdvanceTable/types";
import { useThemeContext } from "../../../context/ThemeContext";
import BasicTHCell from "../../common/AdvanceTable/BuiltIn/Cells/BasicTHCell";
      ...
      >
        <Summary isExpandable={expandable}>
          {isTotalCard ? (
            ...
            <MonthHeader isLight={isLight}>
              {row.cells[0].value as React.ReactNode}
            </MonthHeader>
          )}
        ...
        <AccordionDetails>
          <Reported>
            ...
            {hasOffChainData && (
              <NetExpenseTransactions isLight={isLight}>
                Net Expense Transactions
              </NetExpenseTransactions>
            )}
          </Reported>
...
const Value = styled.div<WithIsLight & { isTotal: boolean }>(
  ({ isLight, isTotal }) => ({
