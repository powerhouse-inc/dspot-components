...
import { Token, UIReservesData } from '../../types'
...
const ReserveCard: React.FC<ReserveCardProps> = ({
  ...
  const initialBalance =
    account.snapshotAccountBalance?.[0]?.initialBalance ?? 0
  ...
  return (
    <Accordion
      expanded={expanded}
      onChange={() => hasTransactions && setExpanded(!expanded)}
    >
      <Card isLight={isLight} hasTransactions={hasTransactions}>
        ...
        <InitialBalance>
          ...
          <Value isLight={isLight}>
            ...
            <Currency isLight={isLight}>{currency}</Currency>
          </Value>
        </InitialBalance>
      ...
      {hasTransactions && (
        <TransactionContainer>
          <TransactionList
            items={
              isGroup ? account.children : account.snapshotAccountTransaction
            }
          />
        </TransactionContainer>
      )}
