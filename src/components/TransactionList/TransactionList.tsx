...
import { WithIsLight, isSnapshotAccount } from "../../utils/typesHelpers";
import GroupItem from "../GroupItem/GroupItem";
import InitialBalanceRow from "../Transaction/InitialBalanceRow";
import Transaction from "../Transaction/Transaction";
import { SnapshotAccount, SnapshotAccountTransaction } from "../../types";
  ...
  return (
    <TransactionListContainer isLight={isLight}>
      <TransactionCard isLight={isLight}>
        {!items?.length && (
          <EmptyList isLight={isLight}>No transactions this month</EmptyList>
        )}
          ...
          isSnapshotAccount(item) ? (
            <GroupContainer isLight={isLight} key={item.id}>
              <GroupItem
                ...
                initialBalance={
                  item.snapshotAccountBalance?.[0]?.initialBalance
                }
              ...
              />
              {item.snapshotAccountTransaction.map((transaction) =>
