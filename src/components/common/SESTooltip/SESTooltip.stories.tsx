...
const getCustomBtnTemplate: (
  btnText?: string
) => ComponentStory<typeof SESTooltip> =
  (btnText = 'Hover me') =>
  ({ ...args }) =>
    (
      <WideContainer>
...
const VariablePlacementTemplate: ComponentStory<typeof SESTooltip> = ({
  placement,
  ...args
}) => (
  <CenteredContent>
...
const BoundariesTemplate: ComponentStory<typeof SESTooltip> = ({
  placement,
  ...args
}) => (
  <OverflownContainer
...
const CustomStyledTemplate: ComponentStory<typeof SESTooltip> = ({
  placement,
  ...args
}) => (
  <CenteredContent>
 ...
 */
export const ModalBottomSheet = getCustomBtnTemplate(
  'Open as Modal Bottom (real mobile only)'
).bind({})
ModalBottomSheet.args = {
  showAsModalBottomSheet: true,
}

export const [[withArrowLight, withArrowDark]] = createThemeModeVariants(
  getCustomBtnTemplate('With Arrow'),
  [{ arrow: true }]
)
