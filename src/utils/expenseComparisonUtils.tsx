      ...
      const row = buildRow(
        [
          ...
          formatExpenseWithCurrency(
            comparison.netExpenses.onChainOnly.amount,
            currency
          ),
          formatExpenseDifference(
            comparison.netExpenses.onChainOnly.difference
          ),
          formatExpenseWithCurrency(
            comparison.netExpenses.offChainIncluded.amount,
            currency
          ),
          formatExpenseDifference(
            comparison.netExpenses.offChainIncluded.difference
          ),
        ],
      ...
      rows.push(
        buildRow(
          [
            ...
            formatExpenseWithCurrency(
              totals.netExpenses.offChainIncluded.amount,
              currency
            ),
            formatExpenseDifference(
              totals.netExpenses.offChainIncluded.difference
            ),
          ],
          false,
          true
